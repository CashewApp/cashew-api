package br.app.cashew.feature01.authentication.util;
...
public class FingerprintGeneratorUtility {


    private FingerprintGeneratorUtility() {
    ...
    * */
    ...
    public static String generateUserFingerprint() {
    ...
    public static String hashUserFingerPrint(String userFingerprint) {
    ...
    public static boolean validateUserFingerprint(String userFingerprint, String jwtUserFingerprint) {
